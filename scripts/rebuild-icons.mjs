...
const HANDCRAFTED = {
  ...
  21: {
    ...
    note: "Fixed chevrons: old triangles stacked wrong and missing brown/black. Now correct Progress Pride geometry.",
    shapes: [
      { t: "rect", x: 3, y: 4, w: 18, h: 2.67, fill: "#e40303" },
      { t: "rect", x: 3, y: 6.67, w: 18, h: 2.67, fill: "#ff8c00" },
      { t: "rect", x: 3, y: 9.34, w: 18, h: 2.66, fill: "#ffed00" },
      { t: "rect", x: 3, y: 12, w: 18, h: 2.67, fill: "#008026" },
      { t: "rect", x: 3, y: 14.67, w: 18, h: 2.66, fill: "#24408e" },
      { t: "rect", x: 3, y: 17.33, w: 18, h: 2.67, fill: "#732982" },
      // chevrons from outer (left) to tip (right): black, brown, light blue, pink, white
      { t: "polygon", points: "3,4 3,20 11,12", fill: "#000000" },
      { t: "polygon", points: "3,4 3,20 10,12", fill: "#613915" },
      { t: "polygon", points: "3,4 3,20 9,12", fill: "#74d7ee" },
      { t: "polygon", points: "3,4 3,20 8,12", fill: "#ffafc8" },
      { t: "polygon", points: "3,4 3,20 7,12", fill: "#ffffff" },
    ],
  },
  22: {
  ...
  33: {
    name: "Om symbol",
    note: "No accurate Lucide Om. Rebuilt simplified Devanagari-inspired Om strokes (approximation; not a font glyph).",
    shapes: [
      {
        t: "path",
        d: "M4.8 14.2c0-2.8 2-5 4.8-5 1.6 0 2.8.7 3.5 1.8",
        stroke: "#ea580c",
        sw: 1.7,
        fill: "none",
      },
      {
        t: "path",
        d: "M8.2 16.8c1.4 1.4 3.6 1.6 5.2.4 1.4-1 1.8-2.6 1.2-4.1-.6-1.4-2-2.2-3.4-2",
        stroke: "#ea580c",
        sw: 1.7,
        fill: "none",
      },
      {
        t: "path",
        d: "M14.5 11.5c1.2.2 2.6 1.1 3.2 2.6.8 1.8.2 3.8-1.4 4.8",
        stroke: "#ea580c",
        sw: 1.7,
        fill: "none",
      },
      { t: "circle", cx: 16.2, cy: 5.6, r: 1.15, fill: "#ea580c" },
      {
        t: "path",
        d: "M13.2 4.4c1.4.5 2.6 1.6 3.2 3",
        stroke: "#ea580c",
        sw: 1.4,
        fill: "none",
      },
      {
        t: "path",
        d: "M18.6 4.8c.9.9 1.4 2.1 1.4 3.4",
        stroke: "#ea580c",
        sw: 1.4,
        fill: "none",
      },
  ...
  35: {
    ...
    note: "Fixed crescent boolean and moved star to the open side so it reads as a clear star-and-crescent.",
    shapes: [
      {
        t: "path",
        d: "M14.8 4.2A8.5 8.5 0 1 0 14.8 19.8 7 7 0 0 1 14.8 4.2z",
        fill: "#fde68a",
      },
      {
        t: "polygon",
        points: starPoints(17.6, 8.2, 5, 2.4, 1),
        fill: "#fde68a",
      },
    ],
  },
